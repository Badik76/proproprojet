...
class timerdv extends database {
     ...
     * @return type ARRAY
     */
    public function getTimeRDVList() {
     ...
     * @return BOOLEAN
     */
    public function getTimeRDVById() {
        $isCorrect = false;
        ...
        $query = 'SELECT `id`, `lastname`, `firstname`, DATE_FORMAT(`birthdate`, "%d/%m/%Y") AS `birthdate`, `phone`, `mail` FROM `USERS` WHERE `id` = :idUser';
    ...
    public function updateUserById() {
        ...
        // Insertion des valeurs des variables via les marqueurs nominatifs, ex :lastname).
        $query = 'UPDATE `USERS` SET `lastname` = :lastname, `firstname` = :firstname, `birthdate` = :birthdate, `phone` = :phone, `mail` = :mail, `adress` = :adress WHERE `id` = :idUser';
