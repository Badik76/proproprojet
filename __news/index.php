            ...
            <div class="container-fluid ">
                ...
                <div class="row">
                    <?php foreach ($listPrestations AS $prestation) { ?>
                        <div class="col s12 m4 l4">
                            <div class="card">
                                <div class="card-image">
                                    ...
                                    <a class="btn-floating halfway-fab waves-effect waves-light backgroundcolor modal-trigger" href="#modalID<?= $prestation->id ?>"><i class="material-icons">add</i></a>
                                </div>
                        ...
                        <div id="modalID<?= $prestation->id ?>" class="modal">
                            <div class="modal-content">
                                <form id="addRDV" action="index.php?PrestabyID=<?= $prestation->id ?>" method="POST">
                                    <fieldset>
                                        <legend>Prendre un RDV <?= $prestation->Prestaname ?></legend>
                                        <p class="center-align"><?= $addRDVSuccess ? 'Le rdv est enregistré' : '' ?><p>
                                        <p><?= $prestation->description ?></p>
                                        <div>
                                            <label for="daterdv">Date du RDV</label>
                                            <input name="daterdv" type="text" id="daterdv" required class="validate datepicker" value="<?= isset($_POST['dateRDV']) ? $_POST['dateRDV'] : ''; ?>" />
                                        </div>
                                        <div class="input-field">
                                            ...
                                            <select id="idTimeRDV" name="idTimeRDV">
                                                ...
                                                <?php foreach ($showTimeRDV AS $timerdv) { ?>
                                                    <option value="<?= $timerdv->id ?>"><?= $timerdv->timeRDV ?></option>
                                                <?php } ?>
                                            </select>
                                            <p class="error"><?= isset($errorArray['idTimeRDV']) ? $errorArray['idTimeRDV'] : '' ?></p>
                                        </div>
                                        <div class="input-field">
                                            <label for="idUser">Users</label>
                                            ...
                                            <p class="error"><?= isset($errorArray['idUser']) ? $errorArray['idUser'] : '' ?></p>
                                        </div>
                                        <div class="input-field">
