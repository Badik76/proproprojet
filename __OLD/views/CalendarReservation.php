<div id="modal" class="modal">
    <div class="modal-content">
        <div id="one" class="container calendar"  ng-app="myApp">
            <div class="app-container" ng-controller="dateTimeCtrl as ctrl" ng-cloak>
                <div date-picker
                     datepicker-title="Choisir votre Rendez-vous"
                     picktime="true"
                     pickdate="true"
                     pickpast="false"
                     mondayfirst="false"
                    ...
                    <div class="datepicker"
                        ...
                        <form method="post" action="rdvok.php">
                            ...
                            <div id="buttons-container" class="buttons-container">                             
                                <input type="reset" class="cancel-button modal-close waves-effect waves-red" value="CANCEL" />
                                <input type="submit" class="save-button modal-close waves-effect waves-green" value="SAVE" />
                            </div>
                        </form>
                    </div>
                </div>
